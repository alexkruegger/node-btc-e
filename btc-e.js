...
BTCE.prototype.getUserInfo = function (callback) {
...
BTCE.prototype.trades = function (pair, options, callback) {
  this.makePublicApiRequest(pair, 'trades', options, callback);
};
...
BTCE.prototype.info = function (pair, callback) {
  this.makePublicApiRequest(pair, 'info', {}, callback);
};
